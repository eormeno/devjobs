    ...
    <div
                ...
                @auth
                    @can('view.vacancies')
                        <a href="{{ url('/dashboard') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{ __('welcome.dashboard') }}</a>
                    @endcan
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{ __('welcome.login') }}</a>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <x-logo color="#394d75" bg="#fefefe" size=40 shadow=true />
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            <div
                                ...
                                <x-icon name="vision" class="w-8 h-8 stroke-blue-500" stroke-width="1.5" />
                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                                {{ __('welcome.vision') }}</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('welcome.vision_text') }}
                            </p>
                        </div>

                        <x-icon name="arrow" stroke-width="1.5"
                    ...
                    <div
                        ...
                        <div>
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <x-icon name="home" class="w-7 h-7 stroke-red-500" stroke-width="1.5" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" class="w-7 h-7 stroke-red-500">
                                    <path stroke-linecap="round" stroke-linejoin="round"
