<form class="md:w-1/2 space-y-5" wire:submit.prevent='editVacant' novalidate>
    @csrf
    <!-- title -->
    <div>
    ...
    <div>
        ...
        <div class="my-5 w-32">
            <img src="{{ asset('storage/images/vacants/' . $image) }}" alt="{{ 'Image ' . $title }}" class="w-full" />
        </div>
        <div class="my-5 w-32">
            @if ($new_image)
                <img src="{{ $new_image->temporaryUrl() }}" alt="image" class="w-full">
            @endif
        </div>
